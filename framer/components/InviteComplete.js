// InviteComplete.js — Invite.tsx 기능을 jsx runtime 기반 JS로 변환
// - 브라우저 ESM
...
function renderBoldSegments(text, baseStyle) {
  ...
  while ((m = re.exec(text)) !== null) {
    ...
    if (start > last) {
      ...
      if (chunk) {
        children.push(
          jsx("span", { key: `nb-${key++}`, style: baseStyle || undefined, children: chunk })
        );
      }
    }
    const boldText = m[1];
    children.push(
      jsx(
        ...
        {
          key: `b-${key++}`,
          style: { ...(baseStyle || {}), fontFamily: "Pretendard SemiBold" },
          children: boldText
        }
      )
    );
...
function renderInvitationSegments(text) {
...
function ChrysanthemumIcon() {
  return React.createElement(
    ...
    React.createElement(
      "svg",
      { xmlns: "http://www.w3.org/2000/svg", width: 13, height: 20, viewBox: "0 0 13 20", fill: "none" },
...
function InviteComplete(props) {
  ...
  useEffect(() => {
    ...
    async function loadInvite() {
      ...
      try {
        ...
        if (mounted && result && result.success && result.data) {
          const d = result.data;
          setWeddingData({
        ...
        if (mounted) setError(e && e.message ? e.message : "초대장 데이터를 불러오지 못했습니다");
      } finally {
  ...
  const dotNeeded = useMemo(() => (a, b) => !!(a && b), []);
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            "div",
            { style: { display: "inline-flex", justifyContent: "flex-start", alignItems: "center", gap: 4 } },
            React.createElement(
              "div",
              { style: { justifyContent: "flex-start", alignItems: "center", gap: 4, display: "flex" } },
              weddingData.showGroomFatherChrysanthemum ? React.createElement(ChrysanthemumIcon) : null,
              React.createElement(
                "div",
                { style: { color: "black", fontSize: 18, fontFamily: "Pretendard Regular", lineHeight: "32px", wordWrap: "break-word" } },
                weddingData.groomFatherName || ""
              ),
              dotNeeded(weddingData.groomFatherName, weddingData.groomMotherName)
                ? React.createElement(
                    "div",
                    { style: { color: "black", fontSize: 18, fontFamily: "Pretendard Regular", lineHeight: "32px", wordWrap: "break-word" } },
                    "·"
                ...
                : null,
              weddingData.showGroomMotherChrysanthemum ? React.createElement(ChrysanthemumIcon) : null,
              React.createElement(
                "div",
                { style: { color: "black", fontSize: 18, fontFamily: "Pretendard Regular", lineHeight: "32px", wordWrap: "break-word" } },
          ...
          React.createElement(
            ...
            React.createElement(
              "div",
              { style: { justifyContent: "flex-start", alignItems: "center", gap: 4, display: "flex" } },
              weddingData.showBrideFatherChrysanthemum ? React.createElement(ChrysanthemumIcon) : null,
              React.createElement(
                "div",
                { style: { color: "black", fontSize: 18, fontFamily: "Pretendard Regular", lineHeight: "32px", wordWrap: "break-word" } },
                weddingData.brideFatherName || ""
              ),
              dotNeeded(weddingData.brideFatherName, weddingData.brideMotherName)
                ? React.createElement(
                    "div",
                    { style: { color: "black", fontSize: 18, fontFamily: "Pretendard Regular", lineHeight: "32px", wordWrap: "break-word" } },
                    "·"
                ...
                : null,
              weddingData.showBrideMotherChrysanthemum ? React.createElement(ChrysanthemumIcon) : null,
              React.createElement(
                "div",
                { style: { color: "black", fontSize: 18, fontFamily: "Pretendard Regular", lineHeight: "32px", wordWrap: "break-word" } },
        ...
        React.createElement(
          "div",
          { style: { width: "100%", flexDirection: "column", justifyContent: "flex-start", alignItems: "flex-start", display: "inline-flex" } },
          React.createElement(
            "div",
            { style: { alignSelf: "stretch", color: "black", fontSize: 18, fontFamily: "Pretendard SemiBold", lineHeight: "32px", wordWrap: "break-word" } },
