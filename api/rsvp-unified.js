            ...
            const renderStatisticsTab = () => (
                <div style={{ display: "flex", flexDirection: "column", gap: "12px", marginTop: "20px" }}>
                    <div style={{ backgroundColor: cardBackgroundColor, padding: "24px" }}>
                        <h3 style={{ fontSize: "14px", color: headerColor, marginBottom: "12px", textAlign: "center", fontWeight: 600, fontFamily: '"Pretendard Variable", Pretendard, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, "Apple SD Gothic Neo", "Noto Sans KR", "Apple Color Emoji", "Segoe UI Emoji"' }}>참석 여부</h3>
                        ...
                        <div style={{ display: "flex", gap: "6px" }}>
                            <div style={{ flex: "1", padding: "0 12px", textAlign: "center" }}>
                                <div style={{ fontSize: "12px", color: "#666666", marginBottom: "8px", fontWeight: 600, fontFamily: '"Pretendard Variable", Pretendard, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, "Apple SD Gothic Neo", "Noto Sans KR", "Apple Color Emoji", "Segoe UI Emoji"' }}>참석가능</div>
                                <div style={{ fontSize: "16px", color: headerColor, fontWeight: 600, fontFamily: '"Pretendard Variable", Pretendard, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, "Apple SD Gothic Neo", "Noto Sans KR", "Apple Color Emoji", "Segoe UI Emoji"' }}>{summary.attending}</div>
                            </div>
                            <div style={{ flex: "1", padding: "0 12px", textAlign: "center" }}>
                                <div style={{ fontSize: "12px", color: "#999999", marginBottom: "8px", fontFamily: '"Pretendard Variable", Pretendard, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, "Apple SD Gothic Neo", "Noto Sans KR", "Apple Color Emoji", "Segoe UI Emoji"' }}>신랑측</div>
                                <div style={{ fontSize: "16px", color: groomSideColor, fontWeight: 600, fontFamily: '"Pretendard Variable", Pretendard, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, "Apple SD Gothic Neo", "Noto Sans KR", "Apple Color Emoji", "Segoe UI Emoji"' }}>{summary.groomSideAttending}</div>
                            </div>
                            <div style={{ flex: "1", padding: "0 12px", textAlign: "center" }}>
                                <div style={{ fontSize: "12px", color: "#999999", marginBottom: "8px", fontFamily: '"Pretendard Variable", Pretendard, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, "Apple SD Gothic Neo", "Noto Sans KR", "Apple Color Emoji", "Segoe UI Emoji"' }}>신부측</div>
                                <div style={{ fontSize: "16px", color: brideSideColor, fontWeight: 600, fontFamily: '"Pretendard Variable", Pretendard, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, "Apple SD Gothic Neo", "Noto Sans KR", "Apple Color Emoji", "Segoe UI Emoji"' }}>{summary.brideSideAttending}</div>
                            </div>
                        </div>
                    </div>
                    <div style={{ backgroundColor: cardBackgroundColor, padding: "24px" }}>
                        <h3 style={{ fontSize: "14px", color: headerColor, marginBottom: "12px", textAlign: "center", fontWeight: 600, fontFamily: '"Pretendard Variable", Pretendard, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, "Apple SD Gothic Neo", "Noto Sans KR", "Apple Color Emoji", "Segoe UI Emoji"' }}>식사 여부</h3>
                        <div style={{ width: "100%", height: "1px", backgroundColor: borderColor, marginBottom: "16px" }} />
                        <div style={{ display: "flex", gap: "6px" }}>
                            <div style={{ flex: "1", padding: "0 12px", textAlign: "center" }}>
                                <div style={{ fontSize: "12px", color: "#666666", marginBottom: "8px", fontWeight: 600, fontFamily: '"Pretendard Variable", Pretendard, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, "Apple SD Gothic Neo", "Noto Sans KR", "Apple Color Emoji", "Segoe UI Emoji"' }}>식사 인원</div>
                                <div style={{ fontSize: "16px", color: headerColor, fontWeight: 600, fontFamily: '"Pretendard Variable", Pretendard, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, "Apple SD Gothic Neo", "Noto Sans KR", "Apple Color Emoji", "Segoe UI Emoji"' }}>{summary.mealCount}</div>
                            </div>
                            <div style={{ flex: "1", padding: "0 12px", textAlign: "center" }}>
                                ...
                                <div style={{ fontSize: "16px", color: groomSideColor, fontWeight: 600, fontFamily: '"Pretendard Variable", Pretendard, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, "Apple SD Gothic Neo", "Noto Sans KR", "Apple Color Emoji", "Segoe UI Emoji"' }}>{summary.groomMealCount}</div>
                            </div>
                            <div style={{ flex: "1", padding: "0 12px", textAlign: "center" }}>
                                ...
                                <div style={{ fontSize: "16px", color: brideSideColor, fontWeight: 600, fontFamily: '"Pretendard Variable", Pretendard, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, "Apple SD Gothic Neo", "Noto Sans KR", "Apple Color Emoji", "Segoe UI Emoji"' }}>{summary.brideMealCount}</div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            const renderListTab = () => (
                <>
                     ...
                     <div style={{ display: "flex", gap: "6px", alignItems: "center", marginBottom: "12px" }}>
                         ...
                         >
                             <span style={{ fontSize: "12px", color: "#333333", fontFamily: '"Pretendard Variable", Pretendard, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, "Apple SD Gothic Neo", "Noto Sans KR", "Apple Color Emoji", "Segoe UI Emoji"' }}>
                                 {filterType === "all" ? "전체" :
                     ...
                     <div style={{ padding: "6px 0", display: "flex", justifyContent: "center", alignItems: "center", marginBottom: "32px" }}>
                         ...
                         >
                             ...
                             <span style={{ color: "#333333", fontSize: "12px",fontWeight: 600, fontFamily: '"Pretendard Variable", Pretendard, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, "Apple SD Gothic Neo", "Noto Sans KR", "Apple Color Emoji", "Segoe UI Emoji"' }}>
                                 CSV 다운로드
                             </span>
                         </button>
                     </div>
                             ...
                             <div key={index} style={{ display: "flex", flexDirection: "column", gap: "12px", padding: "8px 0" }}>
                                 <div style={{ display: "flex", flexDirection: "column", gap: "9px" }}>
                                     <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                                         <div style={{ display: "flex", alignItems: "center", gap: "2px" }}>
                                             <span style={{ color: "black", fontSize: "14px", fontWeight: 600, fontFamily: '"Pretendard Variable", Pretendard, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, "Apple SD Gothic Neo", "Noto Sans KR", "Apple Color Emoji", "Segoe UI Emoji"' }}>
                                                 {attendee.guest_name}
                                             </span>
                                             {attendee.guest_count && attendee.guest_count > 1 && (
                                                 <span style={{ color: "#8B8B8B", fontSize: "14px", fontFamily: '"Pretendard Variable", Pretendard, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, "Apple SD Gothic Neo", "Noto Sans KR", "Apple Color Emoji", "Segoe UI Emoji"' }}>
                                 ...
                                 <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                                     <div style={{ display: "flex", alignItems: "center", gap: "4px" }}>
                                         <span style={{ color: "#939393", fontSize: "12px", fontFamily: '"Pretendard Variable", Pretendard, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, "Apple SD Gothic Neo", "Noto Sans KR", "Apple Color Emoji", "Segoe UI Emoji"' }}>
                                             {attendee.phone_number}
                                         </span>
                                     </div>
                                     <div style={{ display: "flex", alignItems: "center", gap: "4px" }}>
                                         <div style={{
                                             ...
                                             <span style={{ color: "#ffffff", fontSize: "10px", fontFamily: '"Pretendard Variable", Pretendard, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, "Apple SD Gothic Neo", "Noto Sans KR", "Apple Color Emoji", "Segoe UI Emoji"' }}>
                             ...
                             {Array.from({ length: totalPages }, (_, i) => i + 1).map((page) => (
                                 <button
                                     ...
                                     style={{
                                         ...
                                         width: "32px",
                                         height: "32px",
                                         fontFamily: currentPage === page ? '"Pretendard Variable", Pretendard, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, "Apple SD Gothic Neo", "Noto Sans KR", "Apple Color Emoji", "Segoe UI Emoji"' : '"Pretendard Variable", Pretendard, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, "Apple SD Gothic Neo", "Noto Sans KR", "Apple Color Emoji", "Segoe UI Emoji"',
                                         fontSize: "12px",
                                         fontWeight: 600,
             ...
             return (
                 <div>
                     ...
                     {error && (
                         <div style={{ padding: "12px", backgroundColor: "#fef2f2", color: "#dc2626", borderRadius: "0px", marginBottom: "16px", fontFamily: '"Pretendard Variable", Pretendard, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, "Apple SD Gothic Neo", "Noto Sans KR", "Apple Color Emoji", "Segoe UI Emoji"' }}>
                             {error}
                         </div>
                     )}
                     ...
                     <div style={{ display: "flex", justifyContent: "center", alignItems: "center", marginTop: "12px" }}>
                         ...
                         >
                             ...
                             <span style={{ color: "#999999", fontSize: "12px", fontWeight: 600, fontFamily: '"Pretendard Variable", Pretendard, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, "Apple SD Gothic Neo", "Noto Sans KR", "Apple Color Emoji", "Segoe UI Emoji"' }}>
                                 {isLoading ? "로딩중..." : "새로고침"}
                             </span>
                         </button>
                     </div>
                     ...
                     {!error && !isLoading && attendees.length === 0 && pageId.trim() && (
                         <div style={{ textAlign: "center", padding: "48px 24px", color: "#6b7280" }}>
                             <div style={{ fontSize: "18px", marginBottom: "8px", fontWeight: 600, fontFamily: '"Pretendard Variable", Pretendard, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, "Apple SD Gothic Neo", "Noto Sans KR", "Apple Color Emoji", "Segoe UI Emoji"' }}>
                                 아직 등록된 응답이 없습니다
                             </div>
                         </div>
                     )}
                     ...
                     {!pageId.trim() && (
                         <div style={{ textAlign: "center", padding: "48px 24px", color: "#6b7280" }}>
                             <div style={{ fontSize: "18px", marginBottom: "8px", fontWeight: 600, fontFamily: '"Pretendard Variable", Pretendard, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, "Apple SD Gothic Neo", "Noto Sans KR", "Apple Color Emoji", "Segoe UI Emoji"' }}>
                                 오류가 있습니다. 관리자에게 문의해주세요
                             </div>
                             <p style={{ fontSize: "14px", fontFamily: '"Pretendard Variable", Pretendard, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, "Apple SD Gothic Neo", "Noto Sans KR", "Apple Color Emoji", "Segoe UI Emoji"' }}>
                                 카카오톡 채널 [로아크]로 문의해주세요
                             </p>
                         </div>
                     )}
