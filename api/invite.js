...
// );
//
// -- 기존 테이블에 새 필드 추가 (마이그레이션용)
// alter table public.invite_cards add column if not exists son_label text default '아들';
// alter table public.invite_cards add column if not exists daughter_label text default '딸';
