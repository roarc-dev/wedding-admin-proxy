...
const R2_BUCKET_NAME = process.env.R2_BUCKET_NAME || 'roarc-wedding'
    ...
    <script type="text/babel">
        ...
        function RSVPAttendeeList({ pageId }) {
            ...
            const loadAttendees = async () => {
                ...
                try {
                    const url = "https://wedding-admin-proxy.vercel.app/api/rsvp";
                    const requestBody = {
                        action: "getByPageId",
                        pageId: pageId.trim(),
...
export default async function handler(req, res) {
    ...
    try {
        ...
        // R2에 업로드
        const fileName = `rsvp/${pageId}/index.html`;
        const uploadParams = {
        ...
        // 생성된 URL
        const publicUrl = `https://mcard.roarc.kr/${fileName}`;
