 ...
 */
export default function R2Gallery(props: any) {
    const {
        pageId = "default",
    ...
    // R2 이미지는 변환 URL 지원하지 않으므로 원본 URL 사용
    const getOptimizedUrl = (publicUrl: string, opts?: { width?: number; quality?: number }) => {
        // R2 이미지는 원본 URL 그대로 사용 (변환 서비스 없음)
        return publicUrl
    }
