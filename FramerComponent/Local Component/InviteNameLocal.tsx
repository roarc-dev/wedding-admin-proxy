...
interface InviteNameLocalProps {
    weddingData?: WeddingData
    style?: React.CSSProperties
}

export default function WeddingInvitationLocal(props: InviteNameLocalProps) {
    const { weddingData: propWeddingData, style } = props
    ...
    const weddingData = propWeddingData || defaultWeddingData
...
addPropertyControls(WeddingInvitationLocal, {
    weddingData: {
