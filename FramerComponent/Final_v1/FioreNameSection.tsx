...
export default function FioreNameSection(props: FioreNameSectionProps) {
    ...
    // 최초 진입 시 애니메이션 트리거 (1회만)
    useEffect(() => {
        const timer = setTimeout(() => {
            setHasAnimated(true)
        }, 50) // 약간의 지연을 주어 초기 렌더링 후 애니메이션 트리거
    ...
    // P22 Late November 폰트 스택을 안전하게 가져오기
...
FioreNameSection.defaultProps = {
    groomName: "GROOM NAME",
    brideName: "BRIDE NAME",
}

addPropertyControls(FioreNameSection, {
    groomName: {
